...
// EndLease provides a mock function with given fields: leaseID, accountID, principalID
func (_m *Leaser) EndLease(leaseID string, accountID string, principalID string) {
	_m.Called(leaseID, accountID, principalID)
}
...
// NewLeaser creates a new instance of Leaser. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewLeaser(t interface {
	mock.TestingT
	Cleanup(func())
}) *Leaser {
	mock := &Leaser{}
