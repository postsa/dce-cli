...
// NewLevelLogger creates a new instance of LevelLogger. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewLevelLogger(t interface {
	mock.TestingT
	Cleanup(func())
}) *LevelLogger {
	mock := &LevelLogger{}
