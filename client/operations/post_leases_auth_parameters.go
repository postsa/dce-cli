...
// NewPostLeasesAuthParams creates a new PostLeasesAuthParams object
// with the default values initialized.
func NewPostLeasesAuthParams() *PostLeasesAuthParams {

	return &PostLeasesAuthParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewPostLeasesAuthParamsWithTimeout creates a new PostLeasesAuthParams object
...
// NewPostLeasesAuthParamsWithContext creates a new PostLeasesAuthParams object
...
// NewPostLeasesAuthParamsWithHTTPClient creates a new PostLeasesAuthParams object
...
/*
PostLeasesAuthParams contains all the parameters to send to the API endpoint
for the post leases auth operation typically these are written to a http.Request
*/
